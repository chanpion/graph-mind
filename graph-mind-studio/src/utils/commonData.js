    ...
    data: [
        ...
        },
        {
            ...
            children: [
                ...
                { id: 200004, authName: "图可视化", path: "/home/graph/visual", icon: "View", children: [] },  // 使用View图标，更适合可视化
                ...
                { id: 200007, authName: "图分析", path: "/home/graph/analysis", icon: "DataAnalysis", children: [] }  // 添加图分析菜单项
            ]
        }
    ],
    meta: {
